...
func printTips ( bill:Double, plusTip:[Double] ) {
    print ( "Bill = $\(String(format: "%5.2f", bill)), and a 10% tip would be $\(String(format: "%5.2f", plusTip[0])) for a total of $", bill+plusTip[1] )
...
var tips:[Double] = calculate ( 15.87 )
printTips ( 15.87, plusTip: tips )

var x:[Double] = calculate ( 25.67 )
printTips ( 25.67, plusTip: tips )
